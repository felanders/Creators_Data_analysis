...
# :TODO: Participants 210 in main study and 90 in supplementary study (page 6)
...
```
# :TODO: Review the statement can be interpreted in two ways
  - Mean earnings % of budget: 10%
```{r}
df %>% 
...
# :TODO: Review there is some inconsistency
```{r payoff_cal}
df_cal %>% 
...
# :TODO: Which adjustment methods where used ?
...
# :TODO: Do I have to do a Bayesian Factor Analysis?

# :TODO: Do I have to compute the power of the study?

## Figure 5 (Behavior rival vs. non-rival)

# :TODO: Do I have to add the Number of observations?
...
# :TODO: I get a different coefficient for Law the rest is equal
```{r}
modelsummary(
  models_lr, 
  fmt = 3,
